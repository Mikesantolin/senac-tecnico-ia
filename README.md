...
Contém scripts práticos, exemplos de código CUDA (Python) e scripts de administração Linux (Bash) utilizados nas Aulas.

## Estrutura do Repositório
- `/aulas` : Códigos e materiais práticos separados por aula.
